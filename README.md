...
It combines *voice interaction, smart reminders, AI prediction, and caregiver alerts* to create a fail-proof healthcare support system.
...
- Elderly patients often forget medicines  
- Many users cannot read or understand English  
- Families cannot monitor patients continuously  
- Missed doses can lead to serious health risks  

Existing solutions are:
- Text-heavy  
- Complex  
- Not designed for non-literate users  
...
3. User confirms with a simple tap or voice  
4. If no response → system escalates  
5. Caregiver is notified if dose is missed  
